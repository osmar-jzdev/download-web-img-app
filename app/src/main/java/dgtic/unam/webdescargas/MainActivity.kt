...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            //hiloSecundario("https://poole.ncsu.edu/news/wp-content/uploads/sites/27/2022/06/Heidi-4.png") //URL Not founded, throws an error because can not download anything
            hiloSecundario("https://upload.wikimedia.org/wikipedia/commons/c/cb/Wikimedia_Research_Newsletter_Logo.png")
        }
    }
